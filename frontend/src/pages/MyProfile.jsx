...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'bishtvishal390@gmail.com',
    phone: '+91 8851852009',
    address: {
      line1: '15B Vashisthpurum',
      line2: 'Jankipurum ext. Lucknow',
    },
    gender: 'Male',
    dob: '31-05-2003'
  })
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        <p className="text-neutral-500 underline mt-3">BASIC INOFORMATION</p>
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
      ...
      <div className="mt-10">
        {
          isEdit
          ? <button className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white cursor-pointer transition-all" onClick={() => setisEdit(false)}>Save info</button>
          : <button className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white cursor-pointer transition-all" onClick={() => setisEdit(true)}>Edit</button>
        }
      </div>
